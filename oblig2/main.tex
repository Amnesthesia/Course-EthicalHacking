...
\begin{myfont}
{ \huge \bfseries Ethical Hacking \& Penetration Testing}\\[0cm] % Title of your document
\end{myfont}
...
\begin{myfont}
\textsc{\Large Information Gathering \& Book Review}\\[0.5cm] % Major heading such as course name
...
%----------------------------------------------------------------------------------------
\input{"part1.tex"}
\input{"part2.tex"} % Includes the file that contains the introduction
